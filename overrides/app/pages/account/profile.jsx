            ...
            updateCustomerMutation.mutate(
                {
                    ...
                    body: {
                        ...
                        login: values.email,
                        // Custom attribute: marketingConsent
                        c_marketingConsent: values.marketingConsent
                    }
                },
                {
                    onSuccess: () => {
                            ...
                            >
                                <Text fontSize="sm">
                                    <FormattedMessage
                                        ...
                                        id="profile_card.label.marketing_consent"
                                    />
                                </Text>
                            </Checkbox>
            ...
            <ToggleCardSummary>
                <SimpleGrid columns={{base: 1, lg: 3}} spacing={4}>
                    ...
                    <Box>
                        <Text fontSize="sm" fontWeight="bold" marginBottom={2}>
                            <FormattedMessage
                                defaultMessage="Marketing Consent"
                                id="profile_card.label.marketing_consent_title"
                            />
                        </Text>
                        ...
                        >
                            <Text fontSize="sm">
                                {customer?.c_marketingConsent ? (
                                    <FormattedMessage
                                        defaultMessage="Opted In"
                                        id="profile_card.message.opted_in"
                                    />
                                ) : (
                                    <FormattedMessage
                                        defaultMessage="Opted Out"
                                        id="profile_card.message.opted_out"
                                    />
                                )}
                            </Text>
                        </ChakraSkeleton>
